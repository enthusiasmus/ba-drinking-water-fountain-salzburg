...
<html>
  <head>
    ...
    <meta name="author" content="Wanko Lukas, Nicole Buchegger, Robert Koch, Landesregierung Salzburg"/>
    ...
    <?php if ( $isIos ) { ?>
    <link rel="stylesheet" type="text/css" media="screen" href="assets/css/mobile-ios.css" />
    <?php } else if( $isMobile ){ ?>
    <link rel="stylesheet" type="text/css" media="screen" href="assets/css/mobile-other.css" />
    <?php } ?>
  </head>
  <body>
    <?php if ( !$isMobile ) {
